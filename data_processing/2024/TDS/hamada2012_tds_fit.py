...
TDS_FILE = r'data/Hammada2012/H2_TDS.csv'
RESULTS_FOLDER = r'./data/Hammada2012/fit_results'
...
def main(path_to_csv, path_to_results, tds_ramp_rate):
    ...
    ax.set_title(r'{\sffamily D\textsuperscript{+} → B Hammada (2012)}', usetex=True)
