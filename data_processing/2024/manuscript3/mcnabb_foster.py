"""
This code uses the McNabb-Foster theory described in

Frank, R.C., Lauf, R.J. & Altstetter, C.J. Application of the McNabb-Foster trapping equations
to the diffusion of oxygen in dilute niobium alloys. Metall Trans A 13, 539–543 (1982).
https://doi.org/10.1007/BF02644416

To simulate the TDS spectra of deuterium-sputtered boron
"""
import numpy as np
