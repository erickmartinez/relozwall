...
class SkewNormalFitter:
    ...
    def fit(self, method='de', initial_guess=None, plot=True):
        """
        ...
        bounds = [
            (-20, 20),  # a (shape) - widened range
            (-20, 20),  # loc (location) - widened range
            (0.001, 20)  # scale (must be positive) - widened range
        ]
