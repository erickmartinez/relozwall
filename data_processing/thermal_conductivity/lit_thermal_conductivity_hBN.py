...
database = [
    {
        'material': 'hBN in-plane',
        'dtf_csv': 'Mateti - Adv Funct Materials - 2018 - Bulk Hexagonal Boron Nitride with a Quasi‐Isotropic Thermal Conductivity_in-plane.csv',
        'find_target': True,
        'conductivity_units': 'W/m-K'
    },
    {
        'material': 'hBN cross-plane',
        'dtf_csv': 'Mateti - Adv Funct Materials - 2018 - Bulk Hexagonal Boron Nitride with a Quasi‐Isotropic Thermal Conductivity_cross-plane.csv',
        'find_target': True,
        'conductivity_units': 'W/m-K'
    },
]
...
def main():
    ...
    for i, d in enumerate(database):
        ...
        temperature_interp = np.linspace(298, 650, 50)
