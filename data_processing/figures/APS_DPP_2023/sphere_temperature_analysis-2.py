...
def main():
    ...
    fig.savefig(os.path.join(data_path, save_dir, 'pebble_temperature.svg'), dpi=600)
    ...
    selected_cooling_df.to_csv(os.path.join(data_path, save_dir, 'selected_cooling_data.csv'), index=False, encoding='utf-8-sig')
