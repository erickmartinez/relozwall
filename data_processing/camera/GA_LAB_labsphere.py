...
labsphere_csv = r'../../ir_thermography/optronics_OL_455-12-2_SN_96203007_calibration_table.csv'
...
def main():
    ...
    results_txt += f'A = $\mathregular{{{latex_float_with_error(value=popt[1], error=popt_err[1], digits=0)}}}$'
    ...
    # fig.savefig('GA_LAB_spectrum_20231010.png', dpi=600)
