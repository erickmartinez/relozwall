...
save_path = r'calibration/CALIBRATION_20231010_boron'

TEMP_CAL = 3310.  # K
TEMP_CAL_ERR = 10.  # K
I0 = 1.748E-3
I0_CI = np.array([1.74772E-03, 1.74772E-03])
...
def radiance_at_temperature(temperature: float, wavelength_nm: float, A=EMISSIVITY) -> float:
