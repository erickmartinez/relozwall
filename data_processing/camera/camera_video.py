...
base_path = r'G:\Shared drives\ARPA-E Project\Lab\Data\Laser Tests\SAMPLES\BINDER_CONTENT_SCAN\LCT_R4N14_ROW157_100PCT_2022-12-06_1_images'
...
def main():
    ...
    out = cv2.VideoWriter(
        ...
        os.path.join(base_path, f'{file_tag}.mp4'), cv2.VideoWriter_fourcc(*'mp4v'), frame_rate/10, frameSize
    )
