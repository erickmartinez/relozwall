...
pixel_size = 23.6364
PATTERN_FILENAME = re.compile(r'.*?-(\d+)\.' + IMG_EXTENSION)
nmax = 200
...
def update_line(n, ln, file_list, t0, img0, pulse_width, cal, relative_path, file_tag, fig, image_save_path,
                emission_time, pattern=PATTERN_FILENAME):
    file = file_list[n]
    n_max = len(file_list)
...
if __name__ == '__main__':
    main(calibration_path=CALIBRATION_PATH, img_extension=IMG_EXTENSION, color_map=COLOR_MAP)
