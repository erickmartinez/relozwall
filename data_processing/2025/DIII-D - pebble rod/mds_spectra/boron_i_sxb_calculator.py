...
PEC_KNOT_FILE = './sxb/boron_pec_interpolator.h5'
S_KNOT_FILE = './sxb/boron_ionization_interpolator.h5'


class BoronISXBCalculator:
...
def main(pec_knot_file=PEC_KNOT_FILE, ionization_file=S_KNOT_FILE):
    calculator = BoronISXBCalculator(pec_interpolator_knots_h5=pec_knot_file, ionization_interpolator_knots_h5=ionization_file)
